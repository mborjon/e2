...
<body>
    ...
    <section id='instructions'>
        <h2>Instructions</h2>
        <p>
            It's you vs. the computer! First choose a move: <em>rock</em>, <em>paper</em>, <em>scissors</em>,
            <em>Shoot!</em>
        </p>

        <p>
            The computer will choose its move adn the victor will be declared according to the following rules:
        </p>
